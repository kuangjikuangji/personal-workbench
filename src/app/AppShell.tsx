...
function AccountSummary({ profile, onSignOut, syncStatus }: { profile: Profile; onSignOut(): Promise<void>; syncStatus?: ReactNode }) {
  return (
...
function DesktopNavigation({ hidden, profile, onSignOut, syncStatus }: { hidden: boolean; profile: Profile; onSignOut(): Promise<void>; syncStatus?: ReactNode }) {
  ...
  return (
    <aside aria-hidden={hidden || undefined} className="desktop-sidebar">
      ...
      <AccountSummary profile={profile} onSignOut={onSignOut} syncStatus={syncStatus} />
    </aside>
  );
}

export function AppShell({ children, profile, onSignOut, syncStatus }: PropsWithChildren<{ profile: Profile; onSignOut(): Promise<void>; syncStatus?: ReactNode }>) {
  ...
  return (
    <div className="app-shell">
      <DesktopNavigation hidden={managementOpen} profile={profile} onSignOut={onSignOut} syncStatus={syncStatus} />
